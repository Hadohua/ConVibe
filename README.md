...
**v1.1 新增**: Stats.fm 风格的独立子模块，拥有专属的底部导航栏。
...
主页 (Home)
   └─ 点击 "音乐 Vibe"
       └─ Music Vibe 模块 (独立 Tab 栏)
           ├─ Rankings ──→ 详情页 detail/[type]/[id]
           ├─ Stats
           ├─ Mine (Web3 Hub)
           └─ Exit → 返回主页
```
...
│   │   ├── _layout.tsx           # 自定义底部 Tab 导航
│   │   ├── rankings.tsx          # 排行榜 (Tracks/Artists/Albums)
│   │   ├── stats.tsx             # 统计页面
│   │   ├── mine.tsx              # Web3 Hub (徽章/代币/铸造)
│   │   └── detail/[type]/[id].tsx # 详情页
